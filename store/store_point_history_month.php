...
<script>
        $(function(){
            ...
            ?>
            // 追加
            initializeLiff("<?=$liff_id_store_point_history_month;?>");
        ...
        getProfile = function(){
            liff.getProfile()
                .then(profile => {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?=home_url();?>/wp-json/wp/v2/store_point_history_month",
                        dataType: "text",
                        data:post
                    }).done(function(data){
                        console.log(data);
	...
	<main class="lmf-main_contents">
		<section class="lmf-content">
			...
			<div class="lmf-record_block lmf-white_block">
				<h2 class="lmf-title_bar sky"><em class="label">2024年8月</em></h2>
				<ul class="lmf-record_list">
					<li class="use">
						<b class="title">お客様へのポイント付与</b>
						<p class="point">-3000pt</p>
					</li>
					<li class="get">
