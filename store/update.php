...
<head>
	...
	<script>
		$(function() {
			...
			?>
			// 追加
			initializeLiff("<?= $liff_id_store_update; ?>");
			$('#form').submit(function(event) {
				...
				$.ajax({
					type: "POST",
					url: "<?= home_url(); ?>/wp-json/wp/v2/update_store",
					...
					$.ajax({
                        ...
                        $.each(jsonData,function(i,val) {
                            if(i == 'qrcode') {
								...
								$('#display_store_image').children('img').attr('src',val);
							}else {
				...
				<form id="form" enctype="multipart/form-data">
					<div class="lmf-profedit_block lmf-white_block">
						...
						<dl class="lmf-form_box">
							...
							<dd><em class="input">
								<p id="display_store_image" style="width:150px;"><img src="" alt=""></p>
								<input type="file" name="store_image" id="store_image" class="img_upload">
							</em>
							</dd>
