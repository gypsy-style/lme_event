...
<script>
        $(function(){
            <?php
            $liff_id_profile = get_option('liff_id_point_history');
            $liff_id_form = get_option('liff_id_point_history');
            ?>
            // 追加
        ...
        getProfile = function(){
            liff.getProfile()
                .then(profile => {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "<?=home_url();?>/wp-json/wp/v2/point_history",
                        dataType: "text",
                        data:post
                    }).done(function(data){
                        console.log(data);
		...
		<!-- <section class="lmf-content">
			<div class="lmf-user_block">
				<div class="point_box">
					...
					<b class="points"><span class="point">100</span><span class="unit">pt</span></b>
				</div>
			</div>
			<div class="lmf-record_block lmf-white_block">
				<ul class="lmf-record_list">
					<li class="use">
						...
						<b class="title">green gree garden</b>
						<p class="point">-10pt</p>
					</li>
					<li class="get">
						<span class="icon">ポイント付与</span>
						<em class="data">2023年11月23日 16:04</em>
						<b class="title">green gree garden green gree garden green gree garden</b>
						<p class="point">2000pt</p>
					</li>
					<li class="use">
						<span class="icon">ポイント使用</span>
						<em class="data">2023年11月23日 16:04</em>
						<b class="title">green gree garden</b>
						<p class="point">-200pt</p>
					</li>
					<li class="get">
						<span class="icon">ポイント付与</span>
						<em class="data">2023年11月23日 16:04</em>
